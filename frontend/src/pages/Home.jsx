  ...
  return (
    <div className='flex min-h-screen bg-gray-900'>
      ...
      >
        <div className='p-4'>
          <button
            className='w-full text-left p-2 border border-black text-white bg-transparent hover:bg-black hover:text-white transition-colors mb-2'
            onClick={() => navigate('/search')}
          >
            Search for products
          </button>
          <button
            className='w-full text-left p-2 border border-black text-white bg-transparent hover:bg-black hover:text-white transition-colors'
